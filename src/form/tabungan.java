 ...
 * @author My PC #16
 */
public final class tabungan extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    public void judul(){
        Object[] judul = {"NIS","Nama","Gender"," Kelas","Tanggal"};
    ...
    private void initComponents() {
        ...
        tnis.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        tnis.setSelectionColor(new java.awt.Color(0, 0, 0));
        ...
        cuang.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        ...
        ckembalian.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        ...
        jPanel3.add(bloguss, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 140, 30));
        ...
        crombel.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        ...
        jLabel9.setText("TABUNGAN SISWA SDN 02 Sentul");
...
//        jTextField1.setText(tabModel.getValueAt(tb_sak.getSelectedRow(),4) + "");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        if(tnis.getText().equals("") || tnama.getText().equals("") || cbayar.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Data Tidak Lengkapi!");
        }else{
            try{
                st = cn.createStatement();
                st.executeUpdate("insert into tbl_tabungan set nis='" + tnis.getText()+ "', nama='" +tnama.getText()+ "', kelas ='" +crombel.getText()+ "', u_bayar='" +cbayar.getText()+ "', kembalian='" +ckembalian.getText() + "'," + "tgl='"+ jTextField1.getText()+ "'");
                st.executeUpdate("update tb_siswa set ket='sudah' where nis='"+tnis.getText()+"'");
                JOptionPane.showMessageDialog(null, "Terimakasih Sudah Menabung");
                reset();
                tampilData();
            }catch(Exception e){
                e.printStackTrace();
    ...
    private void breportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_breportActionPerformed
        ...
        try{
//            reportSource = "D:\\ILHAM 16\\NetBeans\\uangkas\\src\\form\\report1.jrxml";
//            reportSource = "C:\\Users\\LENOVO\\OneDrive\\Documents\\NetBeansProjects\\uangkas\\src\\form\\report1.jrxml";
//            reportDest = "D:\\ILHAM 16\\NetBeans\\uangkas\\src\\form\\report1.jasper";
            reportDest = "C:\\Users\\LENOVO\\OneDrive\\Documents\\NetBeansProjects\\uangkas\\src\\form\\report1.jasper";
            
            File fileSource = new File("src/form/report1.jrxml");
